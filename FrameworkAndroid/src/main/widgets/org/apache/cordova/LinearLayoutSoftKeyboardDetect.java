...
/**
 * This class is used to detect when the soft keyboard is shown and hidden in
 * the web view.
 */
public class LinearLayoutSoftKeyboardDetect extends LinearLayout {
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		// gone away.
			...
			if (app != null) app.sendJavascript("cordova.fireDocumentEvent('hidekeyboard');");
		}
		// If the height as gotten smaller then we will assume the soft keyboard has 
		// been displayed.
		else if (height < oldHeight) {
			if (app != null) app.sendJavascript("cordova.fireDocumentEvent('showkeyboard');");
		}
