 ...
 * layout.
 * 
 * Modifed by jjobes - Added mTabTitleViews SparseArray and setTabText(). Also
 * modifed populateTabStrip() to fill mTabTitleViews.
 * 
 */
public class SlidingTabLayout extends HorizontalScrollView {
	 ...
	 * 
	 * @param index
	 *            the index of the tab whose TextView you want to update
	 * @param text
	 *            the text to display on the specified tab's TextView
	 */
