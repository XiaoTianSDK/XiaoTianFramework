...
public class ParallaxScrollView extends ScrollView {
	...
	protected void init(Context context, AttributeSet attrs) {
		if (attrs != null) {
			String XIAOTIAN_NS = context.getResources().getString(R.string.XIAOTIAN_NS);
			this.parallaxFactor = attrs.getAttributeFloatValue(XIAOTIAN_NS, "parallax_factor", DEFAULT_PARALLAX_FACTOR);
			this.alphaFactor = attrs.getAttributeFloatValue(XIAOTIAN_NS, "alpha_factor", DEFAULT_ALPHA_FACTOR);
			this.innerParallaxFactor = attrs.getAttributeFloatValue(XIAOTIAN_NS, "inner_parallax_factor", DEFAULT_INNER_PARALLAX_FACTOR);
			this.numOfParallaxViews = attrs.getAttributeIntValue(XIAOTIAN_NS, "parallax_views_num", DEFAULT_PARALLAX_VIEWS);
		} else {
			this.parallaxFactor = DEFAULT_PARALLAX_FACTOR;
			this.alphaFactor = DEFAULT_ALPHA_FACTOR;
			this.innerParallaxFactor = DEFAULT_INNER_PARALLAX_FACTOR;
			this.numOfParallaxViews = DEFAULT_PARALLAX_VIEWS;
		}
	}
