...
public class CropImageView extends FrameLayout {
	...
	public CropImageView(Context context, AttributeSet attrs) {
		...
		mGuidelines = ua.getIntegerAttribute(ua.getNSXiaoTian(), "guidelines", DEFAULT_GUIDELINES);
		mFixAspectRatio = ua.getBooleanAttribute(ua.getNSXiaoTian(), "fixAspectRatio", DEFAULT_FIXED_ASPECT_RATIO);
		mAspectRatioX = ua.getIntegerAttribute(ua.getNSXiaoTian(), "aspectRatioX", DEFAULT_ASPECT_RATIO_X);
		mAspectRatioY = ua.getIntegerAttribute(ua.getNSXiaoTian(), "aspectRatioY", DEFAULT_ASPECT_RATIO_Y);
		mImageResource = ua.getAttributeResourceValue(ua.getNSXiaoTian(), "imageResource", DEFAULT_IMAGE_RESOURCE);
		init(context);
	}
