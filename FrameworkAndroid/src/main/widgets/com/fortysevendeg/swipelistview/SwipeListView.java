...
public class SwipeListView extends ListView {
	...
	private void init(AttributeSet attrs) {
		...
		if (attrs != null) {
			UtilLayoutAttribute ua = new UtilLayoutAttribute(getContext(), attrs);
			swipeMode = ua.getIntegerAttribute(ua.getNSXiaoTian(), "swipeMode", SWIPE_MODE_BOTH);
			swipeActionLeft = ua.getIntegerAttribute(ua.getNSXiaoTian(), "swipeActionLeft", SWIPE_ACTION_REVEAL);
			swipeActionRight = ua.getIntegerAttribute(ua.getNSXiaoTian(), "swipeActionRight", SWIPE_ACTION_REVEAL);
			swipeOffsetLeft = ua.getDimension(ua.getNSXiaoTian(), "swipeOffsetLeft", 0);
			swipeOffsetRight = ua.getDimension(ua.getNSXiaoTian(), "swipeOffsetRight", 0);
			swipeOpenOnLongPress = ua.getBooleanAttribute(ua.getNSXiaoTian(), "swipeOpenOnLongPress", true);
			swipeAnimationTime = ua.getIntegerAttribute(ua.getNSXiaoTian(), "swipeAnimationTime", 0);
			swipeCloseAllItemsWhenMoveList = ua.getBooleanAttribute(ua.getNSXiaoTian(), "swipeCloseAllItemsWhenMoveList", true);
			swipeDrawableChecked = ua.getAttributeResourceValue(ua.getNSXiaoTian(), "swipeDrawableChecked", 0);
			swipeDrawableUnchecked = ua.getAttributeResourceValue(ua.getNSXiaoTian(), "swipeDrawableUnchecked", 0);
			swipeFrontView = ua.getAttributeResourceValue(ua.getNSXiaoTian(), "swipeFrontView", 0);
			swipeBackView = ua.getAttributeResourceValue(ua.getNSXiaoTian(), "swipeBackView", 0);
		}
