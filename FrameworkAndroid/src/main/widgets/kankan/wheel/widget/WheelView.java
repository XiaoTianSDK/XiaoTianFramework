...
public class WheelView extends View {
	...
	public void setViewAdapter(WheelViewAdapter viewAdapter) {
		if (this.viewAdapter != null) this.viewAdapter.unregisterDataSetObserver(dataObserver);
		this.viewAdapter = viewAdapter;
		if (this.viewAdapter != null) this.viewAdapter.registerDataSetObserver(dataObserver);
		invalidateWheel(true);
	}
	...
	private void doScroll(int delta) {
		...
		if (Math.abs(fixPos) <= itemHeight / 2) fixPos = 0;
		...
		if (scrollingOffset > getHeight()) scrollingOffset = scrollingOffset % getHeight() + getHeight();
	}
