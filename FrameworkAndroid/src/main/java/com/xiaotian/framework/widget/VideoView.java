...
/**
 * VideoView is used to play video, just like {@link android.widget.VideoView
 * VideoView}. We define a custom view, because we could not use
 * {@link android.widget.VideoView VideoView} in ListView. <br/>
...
public class VideoView extends TextureView implements MediaPlayerControl {
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		boolean isKeyCodeSupported = keyCode != KeyEvent.KEYCODE_BACK && keyCode != KeyEvent.KEYCODE_VOLUME_UP && keyCode != KeyEvent.KEYCODE_VOLUME_DOWN && keyCode != KeyEvent.KEYCODE_VOLUME_MUTE
