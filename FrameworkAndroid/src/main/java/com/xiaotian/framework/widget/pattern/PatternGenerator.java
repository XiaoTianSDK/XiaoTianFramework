...
public class PatternGenerator {
	...
	public List<Point> getPattern() {
		...
		for (int ii = 1; ii < pathLen; ii++) {
			...
			Point next = nodeCandidatesList.get(mRng.nextInt(nodeCandidatesList.size()));
	 ...
	 * http://en.literateprograms.org/Euclidean_algorithm_(Java) Accessed on
	 * 12/28/10
	 */
	{
		if (b > a) {
