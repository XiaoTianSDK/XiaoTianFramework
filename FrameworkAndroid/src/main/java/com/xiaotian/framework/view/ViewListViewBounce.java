 ...
 * @name ViewListViewBounce
 * @description
 * @date 2015-6-24
 * @link gtrstudio@qq.com
 * @copyright Copyright © 2010-2015 小天天 Studio, All Rights Reserved.
 */
public class ViewListViewBounce extends ListView implements OnScrollListener, View.OnTouchListener, AdapterView.OnItemSelectedListener {
	...
	// 构造器
	public ViewListViewBounce(Context context) {
		super(context);
		initialize(context);
	}

	public ViewListViewBounce(Context context, AttributeSet attrs) {
		super(context, attrs);
		initialize(context);
	}

	public ViewListViewBounce(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * 
	 * @param bouncing {@code true } for bouncing effect (this is also the
	 ...
	 * forever.
	 * 
	 * @param breakspead Default is 4.0
	 */
