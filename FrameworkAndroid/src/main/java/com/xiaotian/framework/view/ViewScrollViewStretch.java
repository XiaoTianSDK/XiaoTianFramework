 ...
 * @date 2014-04-30
 */
public class ViewScrollViewStretch extends ScrollView {
	...
	public ViewScrollViewStretch(Context context) {
		super(context);
		init();
	}

	public ViewScrollViewStretch(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public ViewScrollViewStretch(Context context, AttributeSet attrs, int defStyle) {
