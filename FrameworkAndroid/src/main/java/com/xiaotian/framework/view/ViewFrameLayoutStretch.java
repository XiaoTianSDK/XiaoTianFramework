 ...
 */
public class ViewFrameLayoutStretch extends FrameLayout implements OnTouchListener {
    ...
    public ViewFrameLayoutStretch(Context context) {
        this(context, null);
    }

    public ViewFrameLayoutStretch(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewFrameLayoutStretch(Context context, AttributeSet attrs, int defStyle) {
    ...
    public final void scrollToTop() {
        scrollToBy(0 - getScrollX(), child.getPaddingTop() - getScrollY());
    }

    public final void scrollToBy(int dx, int dy) {
        if (getChildCount() == 0) {
            // Nothing to do.
            return;
        }
