 ...
 */
public class ViewListViewPinnedSection extends ListView {
    boolean DEBUG = false;
    //-- inner classes
    ...
    //-- constructors
    public ViewListViewPinnedSection(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public ViewListViewPinnedSection(Context context, AttributeSet attrs, int defStyle) {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, ViewListViewPinnedSection.this);
