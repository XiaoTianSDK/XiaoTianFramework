...
public abstract class AsyncTask<Params, Progress, Result> {
	...
	public static final Executor SERIAL_EXECUTOR = UtilSDKVersion.hasHoneycomb() ? new SerialExecutor() : Executors
	...
	private volatile Status mStatus = Status.PENDING; // volatile: 易变
