 ...
 * <li>Lexical scopes must be balanced: every call to {@link #array} must have a matching call to {@link #endArray} and every call to {@link #object} must have a matching call to
 * {@link #endObject}.
 ...
 * 
 * <p>
 * Each stringer may be used to encode a single top level value. Instances of this class are not thread safe. Although this class is nonfinal, it was not designed for inheritance
 * and should not be subclassed. In particular, self-use by overrideable methods is not specified. See <i>Effective Java</i> Item 17,
...
public class JSONStringer {
	 ...
	 * 
	 * @param value
	 *            a {@link JSONObject}, {@link JSONArray}, String, Boolean, Integer, Long, Double or null. May not be {@link Double#isNaN() NaNs} or {@link Double#isInfinite()
	 *            infinities}.
	 * @return this stringer.
	 */
	...
	private void string(String value) {
		...
		for (int i = 0, length = value.length(); i < length; i++) {
			...
			/*
			 * From RFC 4627, "All Unicode characters may be placed within the quotation marks except for the characters that must be escaped: quotation mark, reverse solidus, and
	...
	/**
	 * Inserts any necessary separators and whitespace before a literal value, inline array, or inline object. Also adjusts the stack to expect either a closing bracket or another
	 * element.
	 */
	 ...
	 * 
	 * <p>
	 * <strong>Warning:</strong> although it contradicts the general contract of {@link Object#toString}, this method returns null if the stringer contains no data.
	 */
	@Override
