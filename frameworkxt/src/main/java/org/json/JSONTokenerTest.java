...
public class JSONTokenerTest extends TestCase {
	...
	/**
	 * Tests which characters tokener treats as ignorable whitespace. See Kevin Bourrillion's <a href="https://spreadsheets.google.com/pub?key=pd8dAQyHbdewRsnE5x5GzKQ">list of
