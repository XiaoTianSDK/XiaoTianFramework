...
/**
 * A dense indexed sequence of values. Values may be any mix of {@link JSONObject JSONObjects}, other {@link JSONArray JSONArrays}, Strings, Booleans, Integers, Longs, Doubles,
 * {@code null} or {@link JSONObject#NULL}. Values may not be {@link Double#isNaN() NaNs}, {@link Double#isInfinite() infinities}, or of any type not listed here.
 * 
 * <p>
 ...
 * particular, {@code get} fails if the requested index holds the null reference, but succeeds if it holds {@code JSONObject.NULL}.
 * 
 * <p>
 ...
 * overridable methods is not specified. See <i>Effective Java</i> Item 17, "Design and Document or inheritance or else prohibit it" for further information.
 */
public class JSONArray {
	 ...
	 * 
	 * @param value
	 *            a {@link JSONObject}, {@link JSONArray}, String, Boolean, Integer, Long, Double, {@link JSONObject#NULL}, or {@code null}. May not be {@link Double#isNaN() NaNs}
	 *            or {@link Double#isInfinite() infinities}. Unsupported values are not permitted and will cause the array to be in an inconsistent state.
	 * @return this array.
	 */
	...
	/**
	 * Sets the value at {@code index} to {@code value}, null padding this array to the required length if necessary. If a value already exists at {@code index}, it will be
	 * replaced.
	 * 
	 * @return this array.
	 */
	...
	/**
	 * Returns a new object whose values are the values in this array, and whose names are the values in {@code names}. Names and values are paired up by index from 0 through to
	 * the shorter array's length. Names that are not strings will be coerced to strings. This method returns null if either array is empty.
	 */
	...
	/**
	 * Returns a new string by alternating this array's values with {@code separator}. This array's string values are quoted and have their special characters escaped. For example,
	 * the array containing the strings '12" pizza', 'taco' and 'soda' joined on '+' returns this:
	 * 
	 * <pre>
	 * &quot;12\&quot; pizza&quot; + &quot;taco&quot; + &quot;soda&quot;
	 * </pre>
